module.exports = {
  title: 'miniature-painting', // populated into `manifest.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'oldgeese <hiro.onoda@gmail.com>', // default to `author` in `package.json` or undefined.
  ...
  entry: [
    'miniature-painting.md', // `title` is automatically guessed from the file (frontmatter > first heading).
    // {
    //   path: 'epigraph.md',
